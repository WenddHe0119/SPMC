...
#NOTE:CFG.attack.noise_data_rate = 0.5
CFG.attack.noise_data_rate = 0.3
# CFG.attack.noise_data_rate = 0.2
...
CFG.OPTIMIZER.local_train_lr = 1e-2
...
CFG.Server.FLTrust.public_epoch = 10

CFG.Server.CRFL = CN()
# CFG.Server.CRFL.param_clip_thres = 30
# CFG.Server.CRFL.epoch_index_weight = 2
# CFG.Server.CRFL.epoch_index_bias = 10
# CFG.Server.CRFL.sigma = 0.01
# CFG.Server.CRFL.scale_factor = 2.0

CFG.Server.CRFL.param_clip_thres = 100     # 明显高于当前 norm 上限
CFG.Server.CRFL.epoch_index_weight = 5     # 逐轮上升速度适中
CFG.Server.CRFL.epoch_index_bias = 30      # 第一轮允许的 norm 比当前值略大
CFG.Server.CRFL.scale_factor = 1.0         # 不放大客户端 delta，防止失控
CFG.Server.CRFL.sigma = 1e-4                # 初期不要加噪，先保证能训练起来

CFG.Server.RLR = CN()
CFG.Server.RLR.server_lr = 1.0 # 1.0 1e-1 1e-2 1e-4
CFG.Server.RLR.robustLR_threshold = 4.0 # 0.1 1.0 5.0 10.0 0.5
...
CFG.Optim.PrevSvdFedFish = CN()
CFG.Optim.PrevSvdFedFish.lamda = 5.0
CFG.Optim.PrevSvdFedFish.miu = 5.0

CFG.Optim.PrevSvdAndFish = CN()
CFG.Optim.PrevSvdAndFish.lamda = 1.0

CFG.Optim.PrevSvdTimFish = CN()
CFG.Optim.PrevSvdTimFish.lamda = 1.0
CFG.Optim.PrevSvdTimFish.rank = 3

CFG.Optim.PrevSvdSparFish = CN()
CFG.Optim.PrevSvdSparFish.lamda = 5.0
# CFG.Optim.PrevSvdSparFish.rank = 3

CFG.Optim.PrevSvdHuberFish = CN()
CFG.Optim.PrevSvdHuberFish.lamda = 5.0
# CFG.Optim.PrevSvdSparFish.rank = 3

CFG.Optim.PrevSvdSingleFish = CN()
CFG.Optim.PrevSvdSingleFish.lamda = 5.0

CFG.Optim.PrevSvdToFish = CN()
CFG.Optim.PrevSvdToFish.lamda = 1.0
...
CFG.Optim.AlignedGradient = CN()
CFG.Optim.AlignedGradient.lamda = 1.0

CFG.Optim.AGprox = CN()
CFG.Optim.AGprox.lamda = 1.0
CFG.Optim.AGprox.mu = 0.01

CFG.Optim.SCAFFOLD = CN()
