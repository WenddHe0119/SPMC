...
fpath = 'data0/data_wk/cifar-10-batches-py/data_batch_1'
...
def main(args=None):
    ...
    # 复制一份完全没有被污染的数据集
    total_clean_dataset = copy.deepcopy(private_dataset)
    ...
    fed_method.client_type = client_type
    train(fed_method, fed_server,private_dataset, args, particial_cfg, total_clean_dataset)
